...
<div class="row">
	<div class="span12">
		<p>Lo &uacute;nico que necesitamos es tu nombre (puede ser real o no), tu e-mail, y una contrase&ntilde;a.</p>
			<ul>
	...
	<div class="span12">
		<br />
		<form class="form-horizontal" method="post" action="/Registro/Usuario">
			<fieldset>
